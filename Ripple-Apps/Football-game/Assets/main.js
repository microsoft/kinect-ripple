...
function resetGame() {
    ...
    ballMoving = false;
    drawNetAndField();
    ctx.drawImage(ball, 200 * fieldWidthRatio, 490 * fieldHeightRatio, 100 * (window.innerHeight / 800), 100 * (window.innerHeight / 800));
    currentPosition.x = 200;
    currentPosition.y = 490;
...
function writeCenterText(message) {
    ...
    var startSize = 48
    ctx.font = startSize + "px Segoe UI Light";
    ctx.textBaseline = "middle";
    ctx.textAlign = "Center";
    var actualYStart = 450;
    var actualYEnd = 900;
    ...
    ctx.save();
    ctx.translate(550*fieldWidthRatio,( 125+ (actualYEnd - actualYStart) / 2)*fieldHeightRatio);
...
function notifyWPF() {
    configureScreen("Assets/field.jpg", "Microsoft India", "#FFFFFF");
